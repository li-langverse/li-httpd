...
- Ecosystem sync: `li-toolchain.toml` `lic_commit` (`33757321`) already supersedes upstream tag `studio-verticals-demo-test-dry` (`98cdd7c`); no pin downgrade required for li-httpd.
