...
- Ecosystem sync: `li-toolchain.toml` `lic_commit` (`33757321`) already supersedes upstream tag `studio-demo-2026-05-24` (`55defd82`); no pin downgrade required for li-httpd.
